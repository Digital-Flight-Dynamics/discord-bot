...
export const msfs: CommandDefinition = {
    ...
    execute: async (message, args) => {
        const embed = new Discord.MessageEmbed()
            ...
            .setTitle('Sim Issue')
            .setDescription(
                'This is an issue regarding Microsoft Flight Simulator, as this is the Digital Flight Dynamics A350X Project server, we are unable to provide support for the same.'+
